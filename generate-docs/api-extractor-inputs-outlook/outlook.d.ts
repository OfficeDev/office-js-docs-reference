...
export declare namespace Office {
    ...
    export interface AppointmentCompose extends Appointment, ItemCompose {
        ...
        /**
         * Gets the Exchange Web Services (EWS) item class of the current appointment.
         *
         * @remarks
         * [Api set: Mailbox preview]
         *
         ...
         *                   `Office.AsyncResult` object. The item class of the current appointment is returned in the `asyncResult.value` property. `IPM.Appointment` is
         *                   returned for non-recurring appointments, while `IPM.Appointment.Occurrence` is returned for recurring appointments.
         *
         * @beta
         */
    ...
    export interface MessageCompose extends Message, ItemCompose {
         ...
         * **{@link https://learn.microsoft.com/office/dev/add-ins/outlook/outlook-add-ins-overview#extension-points | Applicable Outlook mode}**: Message Compose
         *
         * **Important**: To preview the `conversationIndex` property, you must install Outlook on Windows Version 2402 (Build 17317.20000) or later. Then, join the
         * {@link https://insider.microsoft365.com/join/Windows | Microsoft 365 Insider program} and select the **Beta Channel** option to access Office beta builds.
         *
         * **Tip**: You can use the `conversationIndex` property value to locate a message in a conversation thread and use its contents
