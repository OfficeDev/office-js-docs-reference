...
call node version-remover ..\api-extractor-inputs-word-release\word_online\word.d.ts "WordApiOnline 1.1" ..\api-extractor-inputs-word-release\word_desktop\word.d.ts
call node version-remover ..\api-extractor-inputs-word-release\word_desktop\word-init.d.ts "WordApiHiddenDocument 1.3" ..\api-extractor-inputs-word-release\word_online\word.d.ts
call node version-remover ..\api-extractor-inputs-word-release\word_desktop\word.d.ts "WordApiHiddenDocument 1.3" ..\api-extractor-inputs-word-release\word_1_3\word.d.ts
...
call node whats-new word ..\api-extractor-inputs-word\word.d.ts ..\api-extractor-inputs-word-release\word_desktop\word-init.d.ts ..\..\docs\includes\word-preview
...
call node whats-new word ..\api-extractor-inputs-word-release\word_desktop\word.d.ts ..\api-extractor-inputs-word-release\word_1_3\word.d.ts ..\..\docs\includes\word-desktop
...
if NOT EXIST "json/word_desktop" (
    echo Running API Extractor for Word desktop.
    pushd api-extractor-inputs-word-release\word_desktop
    call ..\..\node_modules\.bin\api-extractor run
    popd
)
...
if NOT EXIST "yaml/word_desktop" ( call .\node_modules\.bin\api-documenter yaml --input-folder .\json\word_desktop --output-folder .\yaml\word_desktop --office 2> nul )
