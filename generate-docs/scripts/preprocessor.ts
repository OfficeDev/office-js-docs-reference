...
tryCatch(async () => {
    ...
    switch (sourceChoice) {
        case "DT":
            forceRebuild = false;
        case "DT+":
            urlToCopyOfficeJsFrom = "https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/f16109e51300f409524b9a8868057950de25b2b6/types/office-js/index.d.ts";
            urlToCopyPreviewOfficeJsFrom = "https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/f16109e51300f409524b9a8868057950de25b2b6/types/office-js-preview/index.d.ts";
    ...
    makeDtsAndClearJsonIfNew(
        '../api-extractor-inputs-word-release/word_1_3_hidden_document/word-init.d.ts',
        handleCommonImports(handleLiteralParameterOverloads(wordSpecificCleanup(dtsBuilder.extractDtsSection(releaseDefinitions, "Begin Word APIs", "End Word APIs"))), "Other", true),
        "word",
        forceRebuild
    );
