...
export declare namespace Office {
     ...
     * {@link https://docs.microsoft.com/javascript/api/requirement-sets/outlook/requirement-set-1.5/office.context.mailbox.item | Object Model} page.
     * 
     * Child interfaces:
     *
    ...
    export interface Mailbox {
         ...
         * {@link https://docs.microsoft.com/javascript/api/requirement-sets/outlook/requirement-set-1.5/office.context.mailbox#events | events section}.
         *
         * @remarks
         * [Api set: Mailbox 1.5]
         *
