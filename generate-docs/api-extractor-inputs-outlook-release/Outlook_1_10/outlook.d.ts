...
export declare namespace Office {
    ...
    export interface AppointmentCompose extends Appointment, ItemCompose {
         ...
         * {@link https://learn.microsoft.com/javascript/api/requirement-sets/outlook/requirement-set-1.10/office.context.mailbox.item#events | events section}.
         *
         * @remarks
         * [Api set: Mailbox 1.7]
         *
    ...
    export interface Mailbox {
         ...
         * {@link https://learn.microsoft.com/javascript/api/requirement-sets/outlook/requirement-set-1.10/office.context.mailbox#events | events section}.
         *
         * @remarks
         * [Api set: Mailbox 1.5]
         *
