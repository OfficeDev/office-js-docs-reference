...
export declare namespace Office {
     ...
     * {@link https://docs.microsoft.com/office/dev/add-ins/reference/objectmodel/requirement-set-1.5/office.context.mailbox.item | Object Model} page for more information.
     */
