...
export declare namespace CustomFunctions {
     ...
     */
    export interface CancelableInvocation extends Invocation {
        /**
         * @beta
     ...
     */
    export interface CancelableHandler extends CancelableInvocation {
    }
     ...
     */
    export interface StreamingInvocation<ResultType> extends CancelableInvocation {
        /**
         * @beta
     ...
     */
    export interface StreamingHandler<ResultType> extends StreamingInvocation<ResultType> {
    }
}
