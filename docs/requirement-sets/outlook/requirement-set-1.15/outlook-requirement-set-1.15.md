...
Mailbox requirement set 1.15 includes all of the features of [requirement set 1.14](../requirement-set-1.14/outlook-requirement-set-1.14.md). It added the following features.
...
| --- | --- | --- |
| [InitializationContextChanged](/javascript/api/office/office.eventtype?view=outlook-js-1.15&preserve-view=true#fields) | The task pane of an add-in has been opened from an actionable message, `InsightMessage` notification, Smart Alerts dialog, or integrated spam-reporting dialog. Only available with a task pane implementation. | Item |
