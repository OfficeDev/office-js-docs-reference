...
Requirement set 1.1 includes all of the [Common API requirement sets](/office/dev/add-ins/requirement-sets/office-add-in-requirement-sets) supported in Outlook. It added the ability for add-ins to access the body of messages and appointments and the ability to modify the current item.
