...
|---|---|---|:---:|
| [auth](#auth-auth) | Compose<br>Read | [Auth](/javascript/api/office/office.auth?view=outlook-js-1.10&preserve-view=true) | [IdentityAPI 1.3](/office/dev/add-ins/requirement-sets/identity-api-requirement-sets.md) |
