...
> [!NOTE]
> To use APIs in any of the numbered requirement sets or `ExcelApiOnline`, you should reference the **production** library on the [Office.js content delivery network (CDN)](https://officeapis.public.onecdn.static.microsoft/1/office.js).
>
...
| [ExcelApiDesktop 1.1](excel-api-desktop-1-1-requirement-set.md) | Not supported | Version 2509 (Build 19231.20156) | Not supported | Version 16.102 (25101223) | Not supported |
| [ExcelApi 1.21](excel-api-1-20-requirement-set.md) | Supported | Version 2606 (Build 20131.20090) | Not supported | Version 16.110.1 (26062112) | Version 16.102 (25101223) |
