...
The following table lists the SharedRuntime 1.1 and 1.2 requirement sets, the supported Office client applications, and the **minimum** builds or versions for those applications where applicable.
