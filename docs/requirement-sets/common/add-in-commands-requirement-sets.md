...
> [!NOTE]
> Outlook add-ins support add-in commands, but the APIs and manifest elements that enable add-in commands in Outlook are in the [Mailbox 1.3](../outlook/outlook-requirement-set-1-3.md) requirement set. The AddinCommands requirement sets aren't applicable to Outlook.
