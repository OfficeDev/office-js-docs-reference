...
> [!NOTE]
> To use APIs in any of the numbered requirement sets, `WordApiOnline`, `WordApiDesktop`, or `WordApiHiddenDocument`, you should reference the **production** library on the [Office.js content delivery network (CDN)](https://officeapis.public.onecdn.static.microsoft/1/office.js).
>
...
| [WordApiDesktop 1.5](word-api-desktop-1-5-requirement-set.md) | Not applicable | Version 2603 (Build 19822.20168) | Not available | Version 16.108 (26041219) | Not available |
