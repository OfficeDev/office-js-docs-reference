...
The following table lists the Word JavaScript APIs currently included in the `WordApiDesktop 1.5` requirement set. For a complete list of all Word JavaScript APIs (including `WordApiDesktop 1.5` APIs and previously released APIs), see [all Word JavaScript APIs](/javascript/api/word?view=word-js-desktop-1.5&preserve-view=true).

[!INCLUDE[API table](../../includes/word-desktop-1_5.md)]

## See also

- [Word JavaScript API Reference Documentation](/javascript/api/word?view=word-js-desktop-1.5&preserve-view=true)
