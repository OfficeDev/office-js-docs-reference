...
| **ItemClass** | No | Specifies the custom message class to match. For more information, see [Activate a mail add-in in Outlook for a specific message class](https://docs.microsoft.com/en-us/outlook/add-ins/activation-rules). |
...
- [Activation rules for Outlook add-ins](https://docs.microsoft.com/en-us/outlook/add-ins/activation-rules)
- [Match strings in an Outlook item as well-known entities](https://docs.microsoft.com/en-us/outlook/add-ins/match-strings-in-an-item-as-well-known-entities)    
- [Use regular expression activation rules to show an Outlook add-in](https://docs.microsoft.com/en-us/outlook/add-ins/use-regular-expressions-to-show-an-outlook-add-in)