...
| Mailbox   |Outlook for Windows<br>Outlook for web<br>Outlook for Mac<br>Outlook Web App |See [Understanding Outlook API requirement sets](outlook-api-requirement-sets.md).|
