...
> [!NOTE]
> Outlook clients connected to on-premises installations of Exchange 2016 and later with a custom REST URL configured will return an invalid value for `restUrl`.
