...
[mailbox](/javascript/office/objectmodel/requirement-set-1.3/office-mailbox): Provides access to the Outlook Add-in object model for Microsoft Outlook and Microsoft Outlook on the web.
