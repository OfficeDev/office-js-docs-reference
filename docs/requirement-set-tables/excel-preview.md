...
|[NamedItemArrayValues](/javascript/api/excel/excel.nameditemarrayvalues)|[](/javascript/api/excel/excel.nameditemarrayvalues#"[][];)||
...
|[Range](/javascript/api/excel/excel.range)|[](/javascript/api/excel/excel.range#"[][];)||
||[getDependents()](/javascript/api/excel/excel.range#getDependents__)|Returns a `WorkbookRangeAreas` object that represents the range containing all the dependents of a cell in the same worksheet or in multiple worksheets.|
...
|[RangeView](/javascript/api/excel/excel.rangeview)|[](/javascript/api/excel/excel.rangeview#"[][];)||
...
|[TableColumn](/javascript/api/excel/excel.tablecolumn)|[](/javascript/api/excel/excel.tablecolumn#"[][];)||
...
|[TableRow](/javascript/api/excel/excel.tablerow)|[](/javascript/api/excel/excel.tablerow#"[][];)||
