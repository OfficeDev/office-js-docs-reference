...
|:---|:---|:---|
|[ChartFill](/javascript/api/excel/excel.chartfill)||[DataConnectionCollection](/javascript/api/excel/excel.dataconnectioncollection)||[FormulaChangedEventDetail](/javascript/api/excel/excel.formulachangedeventdetail)|[cellAddress](/javascript/api/excel/excel.formulachangedeventdetail#celladdress)|The address of the cell that contains the changed formula.|
...
|[Functions](/javascript/api/excel/excel.functions)||[InsertWorksheetOptions](/javascript/api/excel/excel.insertworksheetoptions)|[positionType](/javascript/api/excel/excel.insertworksheetoptions#positiontype)|The insert position, in the current workbook, of the new worksheets.|
...
|[RangeSort](/javascript/api/excel/excel.rangesort)||[SettableColumnProperties](/javascript/api/excel/excel.settablecolumnproperties)|[format: Excel.CellPropertiesFormat & {            columnWidth?](/javascript/api/excel/excel.settablecolumnproperties#format)|Represents the `format` property.|
