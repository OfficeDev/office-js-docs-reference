...
> [!IMPORTANT]
> Outlook: Registering [Mailbox](../requirement-sets/outlook/preview-requirement-set/office.context.mailbox#events) and [Item](../requirement-sets/outlook/preview-requirement-set/office.context.mailbox.item#events) events is not available when **xsi:type** is `ExecuteFunction`.
...
- [Mailbox 1.5](../requirement-sets/outlook/requirement-set-1.5/outlook-requirement-set-1.5)

> [!IMPORTANT]
> Although the **SupportsPinning** element was introduced in [requirement set 1.5](../requirement-sets/outlook/requirement-set-1.5/outlook-requirement-set-1.5), it's currently only supported for Microsoft 365 subscribers using the following:
>
