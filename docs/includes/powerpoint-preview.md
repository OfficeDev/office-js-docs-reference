...
|[TableColumnAddOptions](/javascript/api/powerpoint/powerpoint.tablecolumnaddoptions)|[specificCellProperties](/javascript/api/powerpoint/powerpoint.tablecolumnaddoptions#powerpoint-powerpoint-tablecolumnaddoptions-specificcellproperties-member)|If provided, specifies properties for each cell in the table column.|
||[uniformCellProperties](/javascript/api/powerpoint/powerpoint.tablecolumnaddoptions#powerpoint-powerpoint-tablecolumnaddoptions-uniformcellproperties-member)|Specifies the formatting which applies uniformly to all of the table column cells.|
|[TableColumnCollection](/javascript/api/powerpoint/powerpoint.tablecolumncollection)|[add(index?: number \| null, count?: number)](/javascript/api/powerpoint/powerpoint.tablecolumncollection#powerpoint-powerpoint-tablecolumncollection-add-member(1))|Adds one or more columns to the table.|
...
|[TableRowAddOptions](/javascript/api/powerpoint/powerpoint.tablerowaddoptions)|[specificCellProperties](/javascript/api/powerpoint/powerpoint.tablerowaddoptions#powerpoint-powerpoint-tablerowaddoptions-specificcellproperties-member)|If provided, specifies properties for each cell in the table row.|
||[uniformCellProperties](/javascript/api/powerpoint/powerpoint.tablerowaddoptions#powerpoint-powerpoint-tablerowaddoptions-uniformcellproperties-member)|Specifies the formatting which applies uniformly to all of the table row cells.|
|[TableRowCollection](/javascript/api/powerpoint/powerpoint.tablerowcollection)|[add(index?: number \| null, count?: number)](/javascript/api/powerpoint/powerpoint.tablerowcollection#powerpoint-powerpoint-tablerowcollection-add-member(1))|Adds one or more rows to the table.|
